...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = window.PDFJS ? window.PDFJS.imageResourcesPath : '/pdfjs/web/images/';
  PDFJS.workerSrc = window.PDFJS ? window.PDFJS.workerSrc : './pdf.worker.js';
  PDFJS.cMapUrl = window.PDFJS ? window.PDFJS.cMapUrl : '/pdfjs/web/cmaps/';
